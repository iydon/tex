...
Subtitle
--------
Titles are underlined (or over- and underlined) with a printing nonalphanumeric 7-bit ASCII character. Recommended choices are "``= - ` : ' " ~ ^ _ * + \hashtag() < >``". The underline/overline must be at least as long as the title text.
...
\hashtag(). This item is auto-enumerated
...
::
  ...
  Whitespace, newlines, blank lines, and all kinds of markup (like *this* or \backslash()this) is preserved by literal blocks.
...
Autonumbered footnotes are possible, like using [\hashtag()]_ and [\hashtag()]_.

.. [\hashtag()] This is the first one.
.. [\hashtag()] This is the second one.

They may be assigned 'autonumber labels' - for instance, [\hashtag()fourth]_ and [\hashtag()third]_.

.. [\hashtag()third] a.k.a. third_

.. [\hashtag()fourth] a.k.a. fourth_
